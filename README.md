...
This is my personal portfolio website built with Astro and Tailwind CSS. It showcases my projects, skills, and professional experience in a modern, responsive design.
...
The portfolio is a static site that can be customized by editing the components in `src/`. To build for production:
